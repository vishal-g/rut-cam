...
add_action('enqueue_block_assets', 'tbones_enqueue_plugin_assets_hp', 98);
// add_action('after_setup_theme', 'tbones_enqueue_plugin_editor_assets_hp', 98);
// add_action('enqueue_block_editor_assets', 'tbones_enqueue_editor_assets_hp', 98);
